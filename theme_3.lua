...
-- 1. A .LUA FILE LIKE THIS ONE WITH A UNIQUE NAME (FOR EXAMPLE "theme2.lua") WHICH IS PLACED IN YOUR PROJECT'S ROOT (WHERE THE "main.lua" IS).
...
local Theme =
	{
	KeyboardFont              = "SF UI Text",
	KeyboardFontSize          = 22,

	--------------------------------------------------------
	-- WINDOW SETTINGS 
	--------------------------------------------------------
	WindowCaptionFont          = "SF UI Text Bold",   -- TO USE CUSTOM FONTS, MAKE SURE THAT 1. IT IS INSTALLED PROPERLY ON YOUR MAC OR PC, 2. PLACE COPY OF THE .TTF FILE IN YOUR PROJECTS ROOT FOLDER, 3. DECLARE THE FONT IN YOUR "build.settings" FILE PROPERLY. 
	WindowFontSize             = 16,            -- FONT SIZE OF WINDOW'S TITLE CAPTION
	WindowCaptionOffsetY       = 3,			-- OFFSET FROM WINDOW'S TOP BORDER TO THE CENTER OF THE CAPTION TEXT, ALSO AFFECTS ICON POSITION.
	...
	WindowShadowOffset         = 9,		    -- WINDOW SHADOW X- AND Y-OFFSET IN PIXELS
	WindowShadowCornerSize     = 6,				-- USE 0 FOR SHARP CORNERS OR ANY OTHER VALUE FOR ROUNDED CORNERS
	...
	-- WIDGET SETTINGS 
	--------------------------------------------------------
	WidgetFont                 = "SF UI Text",   -- TO USE CUSTOM FONTS, MAKE SURE THAT 1. IT IS INSTALLED PROPERLY ON YOUR MAC OR PC, 2. PLACE COPY OF THE .TTF FILE IN YOUR PROJECTS ROOT FOLDER, 3. DECLARE THE FONT IN YOUR "build.settings" FILE PROPERLY. 
	WidgetFontSize             = 14,
	...
	ListIconSize               = 32,            -- SIZE OF A LIST ITEM'S ICON
	...
	WindowCaptionColor1        = {1,1,1},  -- WINDOW TITLE CAPTION TEXT COLOR
	WindowCaptionColor2        = {.07,.15,.07},  -- WINDOW TITLE CAPTION SHADOW COLOR
	WidgetTextColor            = {1,1,1},  -- THE DEFAULT TEXT COLOR OF ALL WIDGETS
	ButtonTextColor            = {1,1,1},  -- COLOR OF BUTTON TEXT CAPTIONS
	...
	ListItemSelectedColor      = {68/255,219/255,94/255,1},  -- SELECTED LIST ITEM BACKGROUND COLOR
